<template>
  <div class="filter-tools">
    ...
    <el-input v-model="orderNo" placeholder="请输入我方标识" maxlength="15"> </el-input>
    <el-input v-model="dealNo" placeholder="请输入对方标识" maxlength="15"> </el-input>
    ...
    <el-select v-model="payChannel" placeholder="请选择支付渠道">
      <el-option
...
export default class FilterTools extends Vue {
  ...
  public payWayList: { [x: string]: any }[] = [
    {
      value: 'blue',
      label: '蓝色',
    },
  ...
  public payChannelList: { [x: string]: any }[] = [
    {
      value: 'wechat',
      label: '微信支付',
    },
